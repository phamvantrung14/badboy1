        ...
        <div class="container">
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                <a class="navbar-brand" href="index.html">
                    <img src="<?php echo e(asset("frontend/img/log-bg.png")); ?>" alt="">
                    <img src="<?php echo e(asset("frontend/img/logo-2.png")); ?>" alt="">
                </a>
                    ...
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="dropdown submenu">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a href="about-us.html"><?php echo e($value->name); ?></a></li>
...
<?php /**PATH C:\xampp3\htdocs\badboy\resources\views/components/header.blade.php ENDPATH**/ ?>