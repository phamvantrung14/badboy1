...
<section class="main_slider_area">
    <div id="main_slider" class="rev_slider"  data-version="5.3.1.6">
        <ul>
            <?php $__currentLoopData = $slide1; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <li  data-transition="fade" style="height: 350px" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="300"    data-rotate="0"  data-saveperformance="off"  data-title="Creative" data-param1="01" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                <!-- MAIN IMAGE -->
                <img src="<?php echo e(asset("upload/slide"."/".$value->image)); ?>"   alt="" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="5" class="rev-slidebg" data-no-retina>
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="welcome_img">
                        <img class="img-fluid" src="<?php echo e(asset("frontend/img/cake-feature/welcome-right.jpg")); ?>" alt="">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="cake_feature_slider owl-carousel">
                ...
                <div class="item">
                    <div class="cake_feature_item">
                        <div class="cake_img">
                            <img src="<?php echo e(asset($value->product_avatar)); ?>" alt="">
                        </div>
                        <div class="cake_text">
                            <h4><?php echo e($loop->index+1); ?></h4>
                            <h3>
                                <p><?php echo e($value->getPrice()); ?></p>
...
<section class="special_recipe_area">
    <div class="container">
        <div class="special_recipe_slider owl-carousel">
            <?php $__currentLoopData = $type_pd1; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="item">
                <div class="media">
                    <div class="d-flex">
                        <img src="<?php echo e(asset($value->image)); ?>" style="width: 150px" alt="">
                    </div>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="discover_item_inner">
                        <?php $__currentLoopData = $products1; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="discover_item">
                            <h4><?php echo e($value->type_product->name); ?></h4>
                            <p><?php echo e($value->__get("product_name")); ?> <span><?php echo e($value->getPrice()); ?></span></p>
                        </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="discover_item_inner">
                        <?php $__currentLoopData = $products2; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="discover_item">
                            <h4>D<?php echo e($value->type_product->name); ?></h4>
                            <p><?php echo e($value->__get("product_name")); ?> <span><?php echo e($value->getPrice()); ?></span></p>
                        </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
        ...
        <div class="client_says_inner">
            ...
            <div class="client_says_slider owl-carousel">
                <div class="item">
                    <div class="media">
                        <div class="d-flex">
                            <img src="<?php echo e(asset("frontend/img/client/client-1.png")); ?>" alt="">
                            <h3>“</h3>
                        </div>
                        <div class="media-body">
    ...
    <div class="container">
        <div class="row our_chef_inner">
            ...
            <div class="col-lg-3 col-6">
                <div class="chef_item">
                    <div class="chef_img">
                        <img class="img-fluid" src="<?php echo e(asset("frontend/img/chef/chef-1.jpg")); ?>" alt="">
                        <ul class="list_style">
            ...
            <div class="col-lg-3 col-6">
                <div class="chef_item">
                    <div class="chef_img">
                        <img class="img-fluid" src="<?php echo e(asset("frontend/img/chef/chef-2.jpg")); ?>" alt="">
                        <ul class="list_style">
                            <li><a href="#"><i class="fa fa-twitter"></i></a></li>
                            <li><a href="#"><i class="fa fa-linkedin-square"></i></a></li>
                            <li><a href="#"><i class="fa fa-facebook-square"></i></a></li>
            ...
            <div class="col-lg-3 col-6">
                <div class="chef_item">
                    <div class="chef_img">
                        <img class="img-fluid" src="<?php echo e(asset("frontend/img/chef/chef-3.jpg")); ?>" alt="">
                        <ul class="list_style">
                            <li><a href="#"><i class="fa fa-twitter"></i></a></li>
                            <li><a href="#"><i class="fa fa-linkedin-square"></i></a></li>
                            <li><a href="#"><i class="fa fa-facebook-square"></i></a></li>
        ...
        <div class="row latest_news_inner">
            <div class="col-lg-4 col-md-6">
                <div class="l_news_image">
                    <div class="l_news_img">
                        <img class="img-fluid" src="<?php echo e(asset("frontend/img/blog/latest-news/l-news-1.jpg")); ?>" alt="">
                    </div>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="l_news_item">
                    <div class="l_news_img">
                        <img class="img-fluid" src="<?php echo e(asset("frontend/img/blog/latest-news/l-news-2.jpg")); ?>" alt="">
                    </div>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="l_news_item">
                    <div class="l_news_img">
                        <img class="img-fluid" src="<?php echo e(asset("frontend/img/blog/latest-news/l-news-3.jpg")); ?>" alt="">
                    </div>
                    <div class="l_news_text">
                        <a href="#"><h5>Oct 15, 2016</h5></a>
                        <a href="#"><h4>Nanotechnology immersion along the information</h4></a>
...
<?php echo $__env->make("components.layout", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp3\htdocs\badboy\resources\views/frontend/index.blade.php ENDPATH**/ ?>